import { createNew, createNewAccountwithCSV, getAll, manageAccount, removeAccount, sendAll, updateAccount, updateFromCSV } from './acount.entity';
...
export default function account() {
  ...
  */
  ...
  /**
  * POST /account
  * @description this route is used to create a account with csv.
  * @response {Object} 200 - the new user account object.
  */
  this.route.post('/accountwithcsv', createNewAccountwithCSV(this));
