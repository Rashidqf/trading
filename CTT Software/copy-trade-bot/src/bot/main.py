...
class TradeDirect():
    ...
    def order(self,*args) -> str :
        return trade_order(self.driver, *args)

    def ammend(self,*args) -> str:
        return ammend_order(self.driver,*args)
    
    def cancel (self,*args)  -> str :
        return cancel_order(self.driver,*args)
        
    def trade(self,*args) -> str :
        return order_trade(self.driver,*args)
        
    def tradetoOrder(self,*args) -> str :
        return toOrder(self.driver,*args)

    def tradeammend(self,*args) -> str:
        return order_ammend(self.driver,*args)
    
    def ordercancel (self,*args) -> str:
