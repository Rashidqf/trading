...
export default function AddAccount() {
    ...
    return (
        <>
            ...
            <div>
        <button onClick={handleModal} className="cursor-pointer font-medium outline-none border-none select-none inline-block px-4 py-[10px] bg-primary rounded-3xl text-regular">Add Account</button>
      </div>
