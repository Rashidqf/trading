...
export default function TradeFormNew({ marketData = {} }) {
  ...
  const onsubmit = async (data) => {
    ...
    if (orderLevels === entryPrice) {
      hitToast("Value should not match", "info");
      setLoading(false);
      return;
    }
  
    const action = tradeType === "order" ? createTrade(data) : createOrder(data);
  ...
  const handleStopLossChange = (e) => {
    ...
    setValue("entryPrice", stopLossValue); // Update entryPrice input
  };
