...
ammend = {
		...
		"trade_date" : "//tr[.//div[starts-with(@id, 'cp-edit-{}')]]/td[contains(@class, 'yui-dt1-col-CreationTime')]/div"
	}
...
common = {
		...
		"place_order" : '//div[contains(text(),"Open Position")]',
		"place_orders" : '//div[contains(text(),"Open Position")]',
